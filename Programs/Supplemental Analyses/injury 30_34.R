...
saveRDS(main_MCMC,"C:\\Users\\bened\\Documents\\GDL Paper\\Code\\Upload to Github\\Output\\Output_injury_30_34.rds")

# IF YOU WANT TO JUST READ IN THE EXISTING OUTPUT:
# main_MCMC <- readRDS("C:\\Users\\bened\\Documents\\GDL Paper\\Code\\Upload to Github\\Output\\Output_injury_30_34.rds")
