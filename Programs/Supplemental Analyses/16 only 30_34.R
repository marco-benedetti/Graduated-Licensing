...
# READ IN DATA 
basedata_trt <- read.csv("C:\\Users\\bened\\Documents\\GDL Paper\\Code\\Upload to Github\\Data\\OhioCrashes_16.csv")
...
nimble_data$offset <- ifelse(analysis_data$AGEGRP=="30-34",analysis_data$LD_30_34,analysis_data$LD_16)
...
saveRDS(main_MCMC ,"C:\\Users\\bened\\Documents\\GDL Paper\\Code\\Upload to Github\\Output\\Output_16_only_30_34.rds")

# IF YOU WANT TO JUST READ IN THE EXISTING OUTPUT:
#main_MCMC <- readRDS("C:\\Users\\bened\\Documents\\GDL Paper\\Code\\Upload to Github\\Output\\Output_16_only_30_34.rds")
