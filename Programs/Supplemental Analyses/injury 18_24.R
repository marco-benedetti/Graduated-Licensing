...
# READ IN DATA 
basedata_trt <- read.csv("C:\\Users\\bened\\Documents\\GDL Paper\\Code\\Upload to Github\\Data\\OhioInj_1617.csv")
basedata_ctrl <- read.csv("C:\\Users\\bened\\Documents\\GDL Paper\\Code\\Upload to Github\\Data\\OhioInj_3034.csv")
...
legend("topright",lty=c(1,1),col=c(2,4),legend=c("16-17","30-34"),cex=1.5)
